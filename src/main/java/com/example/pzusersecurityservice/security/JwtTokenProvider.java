...
import com.example.pzusersecurityservice.exception.CustomException;
...
public class JwtTokenProvider {
    ...
    public String createToken(String username, List<String> appUserRoles) {
        ...
        claims.put("auth", appUserRoles.stream().map(SimpleGrantedAuthority::new).collect(Collectors.toList()));
